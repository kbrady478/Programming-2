...
{
    [Header("General")]
    [SerializeField] private Enemy_State_Controller enemy_State_Controller_Script;   
    ...
    private void FOV_Check()
    {
        ...
        if (range_Checks.Length != 0)
        {
            ...
            if (Vector3.Angle(transform.forward, direction_To_Target) < (FOV_Angle / 2))
            {
                ...
                {
                    player_Visible = true;
                    // Change current_State in Enemy_Movement to Attack
                    enemy_State_Controller_Script.Change_State(4);
                }
                else
        ...
        {
            player_Visible = false;
            enemy_State_Controller_Script.Change_State(3);
        }
    }// end FOV_Check
